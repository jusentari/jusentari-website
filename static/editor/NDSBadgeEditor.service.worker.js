...
/** @type {string} */
const CACHE_VERSION = '1758999606|4362076';
/** @type {string} */
const CACHE_PREFIX = 'NDSBadgeEditor-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'NDSBadgeEditor.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["NDSBadgeEditor.html","NDSBadgeEditor.js","NDSBadgeEditor.offline.html","NDSBadgeEditor.icon.png","NDSBadgeEditor.apple-touch-icon.png","NDSBadgeEditor.audio.worklet.js","NDSBadgeEditor.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["NDSBadgeEditor.wasm","NDSBadgeEditor.pck"];
